		...
		return (
			<div className="container">
				...
				<dialog ref={this.dialogRef} className="mdl-dialog" id="winnerDialog">
					<h4 className="mdl-dialog__title">{this.state.winner === me ? 'You win 😄' : "You lost 😢"}</h4>
					<div className="mdl-dialog__actions mdl-dialog__actions--full-width">
						<button style={{
							marginTop: 20
						}} ref={this.closeDialogRef} onClick={() => {
							this.reset()
						}} type="button" className="mdl-button close">Play again
						</button>
					</div>
				</dialog>
			</div>
	...
	render() {
		return (
			<div>
				...
				<dialog id="register-dialog" ref={this.registerDialog} className="mdl-dialog">
					<h5 className="mdl-dialog__title">UED Caro game</h5>
					<div className="mdl-dialog__content">
						<div className="mdl-textfield mdl-js-textfield" style={{width: '100%'}}>
							<input ref={this.inputRef} style={{width: "100%"}} className="mdl-textfield__input" type="text" id="name"/>
					...
					<div className="mdl-dialog__actions mdl-dialog__actions--full-width">
						<button style={{
							marginTop: 20
						}} ref={this.closeRegisterDialogRef} type="button" className="mdl-button close">Play now
						</button>
					</div>
				</dialog>
			</div>
